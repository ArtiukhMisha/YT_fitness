...
# --------------------------------------------------------------
basic_fetures = ["acc_x", "acc_y", "acc_z", "gyr_x", "gyr_y", "gyr_z"]
sq_fetures = ["acc_r", "gyr_r"]
pca_fetures = ["pca_1", "pca_2", "pca_3", "pca_4"]
time_features = [f for f in df_train.columns if "_temp_" in f]
freq_features = [f for f in df_train.columns if ("_freq" in f) or ("pse" in f)]
cluster_features = ["cluster"]

print(f"Basic features: {len(basic_fetures)}")
print(f"Square features: {len(sq_fetures)}")
print(f"PCA features: {len(pca_fetures)}")
print(f"Time features: {len(time_features)}")
print(f"Frequency features: {len(freq_features)}")
print(f"Cluster features: {len(cluster_features)}")

features_set_1 = list(set(basic_fetures))
features_set_2 = list(set(basic_fetures + sq_fetures + pca_fetures))
...
x_train = participant_df[participant_df["participant"] != 'A'].drop(columns=["label"],axis=1)
y_train = participant_df[participant_df["participant"] != 'A']["label"]

x_test = participant_df[participant_df["participant"] == 'A'].drop(columns=["label"],axis=1)
...
# --------------------------------------------------------------
# Try a more complexmodel with the selected features
# --------------------------------------------------------------
